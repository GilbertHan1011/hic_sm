...
if __name__ == "__main__":
    ...
    handle_valid = open(outputDir + "/" + baseReadsFile + ".hicpro.validPairs", "w")

    if allOutput:
        handle_de = open(outputDir + "/" + baseReadsFile + ".hicpro.DEPairs", "w")
        handle_re = open(outputDir + "/" + baseReadsFile + ".hicpro.REPairs", "w")
        handle_sc = open(outputDir + "/" + baseReadsFile + ".hicpro.SCPairs", "w")
        handle_dump = open(outputDir + "/" + baseReadsFile + ".hicpro.DumpPairs", "w")
        handle_single = open(outputDir + "/" + baseReadsFile + ".hicpro.SinglePairs", "w")
        handle_filt = open(outputDir + "/" + baseReadsFile + ".hicpro.FiltPairs", "w")
    ...
    # Write stats file
    handle_stat = open(outputDir + "/" + baseReadsFile + ".hicpro.RSstat", "w")
